...
source_gaussian1 = source1(:,1:3000);
source_poisson1 = source1(:,3001:6000);
source_bernoulli1 = source1(:,6001:9000);
...
data_sparsity_for_gaussian = nnz(source_gaussian)/(27*1e6);
...
data_sparsity_for_collective_1 = nnz(source1)/(81*1e6);
...
source_gaussian2 = source2(:,1:3000);
source_poisson2 = source2(:,3001:6000);
source_bernoulli2 = source2(:,6001:9000);
...
data_sparsity_for_poisson = nnz(source_poisson)/(27*1e6);
...
data_sparsity_for_collective_2 = nnz(source2)/(81*1e6);
...
source_gaussian3 = source3(:,1:3000);
source_poisson3 = source3(:,3001:6000);
source_bernoulli3 = source3(:,6001:6000);
...
data_sparsity_for_bernoulli = nnz(source_bernoulli)/(27*1e6);
...
data_sparsity_for_collective_3 = nnz(source3)/(81*1e6);
...
writetable(data_spartsity_table, 'table/Data_Sparsity_table_9000.csv','QuoteStrings',true);
...
writetable(RMSE_matrix_table, 'table/RMSE_coldStart_table_9000.csv','QuoteStrings',true);
