...
% //  
% //
% //  Created by Mokhtar Zahdi Alaya on 16/02/2019.
% //
...
RMSE_matrix_letters = [probas' RMSE_relative_collect' ...
                       ...
                       writetable(RMSE_matrix_table, 'RMSE_relatives_6000.csv','QuoteStrings',true);
...
legend({'Collective' 'Gaussian', 'Poisson', 'Bernoulli'},'FontSize',14);
xlabel('Percentage of known entries ', 'FontSize',14);
ylabel('Relative error', 'FontSize',14);
set(get(gca,'ylabel'),'rotation',90)
title('$$d_u = D = 6000$$', 'Interpreter', 'Latex', 'FontSize',14);
saveas(gcf,'table/data_6000_relative_errors.pdf');
