...
writetable(RMSE_matrix_table, 'RMSE_relatives_3000.csv','QuoteStrings',true);
...
title('$$d_u = D = 3000$$', 'Interpreter', 'Latex', 'FontSize',12);
saveas(gcf,'table/data_3000_relative_errors.pdf');
