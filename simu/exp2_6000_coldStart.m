...
mcMax = 10;
decay_collect = 2e-1;
decay_gaussian = 3.3e-1;
decay_poisson = 3.3e-1;
decay_bernoulli = 3.3e-1;
...
source_gaussian1 = source1(:,1:2000);
source_poisson1 = source1(:,2001:4000);
source_bernoulli1 = source1(:,4001:6000);
...
data_sparsity_for_gaussian = nnz(source_gaussian)/(12*1e6);
...
data_sparsity_for_collective_1 = nnz(source1)/(36*1e6);
...
source_gaussian2 = source2(:,1:2000);
source_poisson2 = source2(:,2001:4000);
source_bernoulli2 = source2(:,4001:6000);
...
data_sparsity_for_poisson = nnz(source_poisson)/(12*1e6);
...
data_sparsity_for_collective_2 = nnz(source2)/(36*1e6);
...
source_gaussian3 = source3(:,1:2000);
source_poisson3 = source3(:,2001:4000);
source_bernoulli3 = source3(:,4001:6000);
...
data_sparsity_for_bernoulli = nnz(source_bernoulli)/(12*1e6);
...
source3 = horzcat(M_collective3, source_bernoulli);
data_sparsity_for_collective_3 = nnz(source3)/(36*1e6);
...
Data_sparsity = [data_sparsity_collect1' data_sparsity_gaussian' ...
 ...
 data_spartsity_table = array2table(Data_sparsity, 'VariableNames', colnames_sparsity);
                 ...
                 writetable(data_spartsity_table, 'table/Data_Sparsity_table_6000.csv','QuoteStrings',true);
...
writetable(RMSE_matrix_table, 'table/RMSE_coldStart_table_6000.csv','QuoteStrings',true);
