...
title('$$d_u = D = 6000$$', 'Interpreter', 'Latex');
% legend({'m=1', 'm=2', 'm=3'},'FontSize',10);
saveas(gcf,'rmse_6000_by_time.pdf');
close all;
...
title('$$d_u = D = 6000$$', 'Interpreter', 'Latex');
% legend({'m=1', 'm=2', 'm=3'},'FontSize',10);
saveas(gcf,'rmse_6000_by_iterations.pdf');
close all;
...
title('$$d_u = D = 6000$$', 'Interpreter', 'Latex');
% legend({'m=1', 'm=2', 'm=3'},'FontSize',10);
saveas(gcf,'objective_6000_by_time.pdf');
close all;
...
title('$$d_u = D = 6000$$', 'Interpreter', 'Latex');
% legend({'m=1', 'm=2', 'm=3'},'FontSize',10);
saveas(gcf,'objective_6000_by_iterations.pdf');
close all;
...
title('$$d_u = D = 6000$$', 'Interpreter', 'Latex');
% legend({'m=1', 'm=2', 'm=3'},'FontSize',10);
saveas(gcf,'objective_6000_by_lambdas_lambdas.pdf');
close all;
